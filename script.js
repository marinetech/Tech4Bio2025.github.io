document.addEventListener('DOMContentLoaded', function () {
    function showContent(page) {
        ...
        if (page === 'Home') {
            ...
            document.querySelector('.content').style.top = '45%';

        } else {
            document.querySelector('.background-top-demos').style.transform = 'translateY(-30%)';
            document.querySelector('.content').style.top = '25%';
        }
