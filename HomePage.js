class HomePage extends HTMLElement { // Changed class name to DemosPage
    connectedCallback() {
        ...
        <img src="img/Vertical wave.png" alt="Vertical wave" class="background-content-demos">
            ...
            <br> 
            <p> These technologies also help with real-time monitoring, such as detecting pollutants or tracking the Effects of climate change on the marine environment. By harnessing these tools, marine biologists can make more informed conservation decisions, protect endangered species and better manage marine resources for the future.</p>
            <br> 
